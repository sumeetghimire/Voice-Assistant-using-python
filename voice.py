...
while True:
    ...
    if re.search('launch', res):
        dict_app = {
            ...
            'vs code': 'C:\Users\sumeet\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Visual Studio Code',
        }
    ...
    if re.search('your name|who are you', res):
        print("My name is Zolly, I am your personal assistant")
        t2s("My name is Zolly, I am your personal assistant")
